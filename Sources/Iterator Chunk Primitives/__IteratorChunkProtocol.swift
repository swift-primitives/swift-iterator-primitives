...
//  `Swift.Span`) and not the storage *subject* (`Contiguous` — that word belongs to the memory
//  subject `Memory.Contiguous`), per `operation-domain-naming-and-organization.md` §7 /
//  `[API-NAME-001b]`.
//
